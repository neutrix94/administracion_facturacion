...
$base_path = $config["admin_fact_dir"];
//die("base_path : {$base_path}");
$app->setBasePath($base_path);//'/adminFacturacion/rest'
...
/*******************************************Endpoints cliente para consumir apis*******************************************/
  //clientes
    ...
    require __DIR__ . '/endpoints/sincronizaPrefijoSet.php';
  //ventas
...
/*Deshabilitados*/
    require __DIR__ . '/endpoints/insertar_lote_ventas_administracion_facturacion.php';
