	...
	//enviamos datos por ajax para obtener los filtros
		$.ajax({
			type:'post',
			url:'include/specials/special_queries/header_consultas.php',
			cache:false,
	...
	//enviamos datos por ajax
		$.ajax({
			type:'post',
			url:'include/specials/special_queries/ajax/formulario.php',
			cache:false,
			data:{id:id_consulta},
			success:function(dat){
	...
	//enviamos los datos por ajax
		$.ajax({
			type:'post',
			url:'include/specials/special_queries/ajax/herramientasBD.php',
			cache:false,
			data:{
	...
	//enviamos datos por ajax
		$.ajax({
			type:'post',
			url:'include/specials/special_queries/ajax/genera_consulta.php',
			cache:false,
